...
class PollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post polls_url, params: { poll: { event_id: @poll.event_id, typeform_id: @poll.typeform_id } }
    end
  ...
  test "should update poll" do
    patch poll_url(@poll), params: { poll: { event_id: @poll.event_id, typeform_id: @poll.typeform_id } }
